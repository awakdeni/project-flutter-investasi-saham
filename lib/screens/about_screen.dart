      ...
      child: Column(
        ...
        children: [
          ...
          _buildSection(
            ...
            content:
                'Platform pemantauan saham modern yang membantu Anda mengikuti pergerakan pasar secara real-time dengan cepat, mudah, dan akurat.',
          ),

          _buildSection(
            content:
                'Kami hadir untuk memberikan pengalaman monitoring saham yang simpel namun powerful, sehingga investor pemula maupun trader aktif dapat memantau harga saham, pergerakan market, dan tren investasi kapan saja dan di mana saja.\n\nDengan teknologi real-time data monitoring, Investden membantu pengguna mendapatkan informasi pasar lebih cepat untuk mendukung pengambilan keputusan investasi yang lebih tepat.',
          ),
          ...
          _buildSection(
            title: 'Visi Kami',
            content:
                'Menjadi platform pemantauan saham terpercaya yang memudahkan masyarakat Indonesia dalam mengakses informasi pasar finansial secara real-time.',
